...
# Code copied from https://github.com/firebase/firebase-admin-python/tree/master/snippets/messaging

# installing the firebase admin using pip  
...
send_to_token(registration_token);
# android_message()
